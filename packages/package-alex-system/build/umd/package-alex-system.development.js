...
(function (global, factory) {
  ...
  (global = global || self, factory(global['package-alex-system'] = {}, global.React));
  ...
  /*#__PURE__*/
  function (_Component) {
    inherits(DuidStyle, _Component);

    function DuidStyle(props) {
      var _this;

      classCallCheck(this, DuidStyle);

      _this = possibleConstructorReturn(this, getPrototypeOf(DuidStyle).call(this, props));
      _this.state = {
        styleId: null
      };
      return _this;
  ...
  */
  ...
  var InputButton = function InputButton(props) {
    ...
    return React__default.createElement(React__default.Fragment, null, React__default.createElement("input", _extends_1({
      type: "button",
      className: style,
      value: name,
      name: name
